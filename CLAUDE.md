...
The instructions for this repository live in one file, shared by every agent tool
rather than duplicated per vendor. Claude Code follows the `@` import below.
